...
setDifference (Set (x : xs)) set2
    ...
    where newSet2 = deleteSet x set2
...
prop_elemInResult set1 set2 =
    ...
    where resultUnion = setUnion set1 set2
...
prop_intersection set1 set2 =
    ...
    where resultIntersection = setIntersection set1 set2
...
main = do
    ...
    quickCheck $ forAll generateSets $ \x ->
