...
-- TODO
-- - Add explanations for props with proofs
-- - Add working to show that the rankings are correct
-- - Add Time Spent
...
-- I am 100% sure there is a way better + nicer way of doing this, but it works too
showResults :: [Char]
